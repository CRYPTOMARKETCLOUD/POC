...
{
            var html=`
    <pre id="code-data" class="brush: js">
        ...
        contract ${contract_name}Token is ERC20Interface {
            string public constant symbol = '${symbol2}';
            string public constant name = '${name}';
            uint8 public constant decimals = ${decimal};
